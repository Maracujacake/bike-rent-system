    ...
    <div class="flex justify-center items-center h-screen">
        <div class="max-w-4xl w-full p-8 bg-white rounded shadow-lg text-center">
            <h2 class="text-2xl font-bold text-gray-800 mb-4"><fmt:message key="cliente.info" />:</h2>
                ...
                <a href="${pageContext.request.contextPath}/admin/listCliente" class="block px-4 py-2 my-4 rounded bg-blue-500 text-white font-bold hover:bg-blue-600"><p><fmt:message key="cliente.returnToList" /></a>
        </div>
    </div>
