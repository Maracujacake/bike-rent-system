...
public class ControllerCliente extends HttpServlet {
        ...
        try {
            switch (action) {
            	...
            	case "/procurar": // busca no banco de dados
            		...
            		break;
                case "/editar": // busca no banco de dados
            		paginaEditarCliente(request, response);
            		break;
            	case "/": // menu inicial
    	...
    	if(idCliente != null) {
    		try {
        		...
        		if(cliente != null) {
        			...
        			RequestDispatcher dispatcher = request.getRequestDispatcher("/clienteLogado/clienteView/clienteEspecifico.jsp");
        			dispatcher.forward(request, response);
        		}
    ...
    private void paginaEditarCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        String idCliente = request.getParameter("id");
        if(idCliente != null) {
            try {
                long id = Long.parseLong(idCliente); 
